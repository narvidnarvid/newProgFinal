...
(function(){
    "use strict";
        function userCtrl ($scope,socket ,$rootScope,$http,userService,$location, $cookieStore, $window) {
        ...
        angular.module('userModule').controller('userCtrl', ['$scope','socket', '$rootScope','$http', 'userService','$location', '$cookieStore','$window' , userCtrl])
    ...
    function articleCtrl ($scope, $rootScope,$location ,articleService) {
        var self = this;
    ...
    angular.module('articlesModule').controller('articleCtrl', ['$scope','$rootScope','$location', 'articleService', articleCtrl])


    function facebookCtrl ($scope,$rootScope) {
    // myApp.controller("facebookCtrl", function($scope,$rootScope) {
        ...
        $scope.createPost= function(req, response) {
            FB.api(
                ...
                {
                    "message": req,
                    "access_token": "EAADZBfxRcEZB8BAERMaZC9kuCq7D0LMi9xB0m6ZC3tMHi6L1e0nFD4Gv1kRki7eSDw7nAjwwVzE2c4zttQUvoHzEI4iXnDHZCdGhsc5ZC35ZCjXAVZAQ5tpPq1YL40rQoDjO9ffnFSrQN6GvwQlhytfpSrUJJZBj3jecg3THZAaz2AZBNbQvTyObDnAIWG5YDXpFtGQqnNnzBicHwZDZD",
                },
                function (response) {
    ...
    angular.module('userModule').controller('facebookCtrl', ['$scope','$rootScope', facebookCtrl])
